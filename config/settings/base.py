"""
Base settings — shared across local, test, and production.
...
# ---------------------------------------------------------------------------
# Database (overridden per-environment, default here for convenience)
# ---------------------------------------------------------------------------
DATABASES = {
    "default": env.db(
        "DATABASE_URL", default="postgres://cozy:cozy@localhost:5432/cozy_reads"
    ),
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Cozy Reads API",
    "DESCRIPTION": "Reading tracker backend — books, library, goals, stats.",
    "VERSION": "1.0.0",
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@cozyreads.app")
